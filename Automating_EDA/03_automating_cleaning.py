...
standardise_column_names(df_insurance)
standardise_column_names(df_nba_salaries)
standardise_column_names(df_airbnb)
standardise_column_names(df_airline_satisfaction)
