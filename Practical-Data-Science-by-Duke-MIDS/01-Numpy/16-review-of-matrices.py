...
Matrix Basics
    ...
    - Like vectors, matrices are also a type of numpy array. Unlike vectors—which consist of data organized in a single dimension—matrices consist of data organised along two dimensions in a grid.

    - Like all numpy arrays, matrices are homogeneously typed, meaning the data they hold must always be of the same type.
